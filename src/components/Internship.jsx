  ...
  const textVariants = {
    ...
    return (
        <div id="internship" className='mt-[35px] pt-[65px] mx-6 '>
            ...
            <h4 className="md:text-8xl text-5xl font-bold uppercase pb-4 text-white ">Work</h4>
